...
// Gendered language in teacher reviers 

    // # Hyperelastic energy 
    // ElasticShearModulus = ' -ElasticShearModulus ' +  0.5 * 1e-9 # // n/m 0.5 * 1e-7;
    // AreaDilationModulus = ' -AreaDilationModulus ' + 5e-6
    // # Bending energy 
    // membrane_constant = ' -membrane_constant ' + 2* 1e-16

    // # Area energy 
    // Area_constant = ' -Area_constant ' + 5 * 1e-5
...
// 
        ...
        // std::string output_dir = "/Users/jcrawshaw/Documents/ChasteWorkingDirectory/";
       // std::string output_dir = "ChasteWorkingDirectory";
     ...
     // Create an Applied Force modifier to couple to Flow
        ...
        simulator.AddForce(p_surface_force);
          ...
          //  Shearing Force 
          //  ----------------------------
        // double ElasticShearModulus = 0.5 * 1e-8; // n/m 0.5 * 1e-7;
        // double AreaDilationModulus = 5e-7;
        //  double ElasticShearModulus = 0.5 * 1e-9; // n/m 0.5 * 1e-7;
        //  double AreaDilationModulus = 5e-7;
        ...
        // double membrane_constant = 2* 1e-16;
        ...
        // // Create a Spring Length Modifier to shrink the springs due to the applied shear stress
        // boost::shared_ptr<SpringLengthModifier<2,3> > p_springs_modifier(new SpringLengthModifier<2,3>());
        // p_springs_modifier->SetShearThreshold(wss_threshold);
        // p_springs_modifier->SetReductionFactor(0.01);
        // p_springs_modifier->SetMaxDivisions(90);
        // simulator.AddSimulationModifier(p_springs_modifier);
