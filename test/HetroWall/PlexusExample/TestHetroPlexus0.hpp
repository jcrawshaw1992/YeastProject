...
void TestSetUpCylinderArchive() throw(Exception)
    {
        ...
        cell_population.SetTargetRemeshingEdgeLength(0.00035); 
        ...
        */
        ...
        p_Mesh_modifier->SetRemeshingInterval(30);// I have turned this off because I need to know what will happen without remeshing, and then with remeshing        
