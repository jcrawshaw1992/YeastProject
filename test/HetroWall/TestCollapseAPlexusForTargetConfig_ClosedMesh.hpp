...
public:
    void TestHetroPlexus() throw(Exception)
    {
        ...
        // std::string mesh_file = "/Users/jcrawshaw/docker-polnet-master/PlexusNotScalled/Plexus_2.vtu";
        std::string mesh_file = "/Users/jcrawshaw/docker-polnet-master/Plexus_Course_2/Plexus_2.vtu";
        ...
        */
        ...
        p_ForceOut->SetPressure(TransmuralPressure*3);
        ...
        */
        ...
        {
            boost::shared_ptr<FixedRegionBoundaryCondition<2,3> > p_condition(new FixedRegionBoundaryCondition<2,3>(&cell_population,boundary_plane_points[boundary_id],boundary_plane_normals[boundary_id],2.155));
        ...
        PRINT_4_VARIABLES(NearestNodesMap[171][0], NearestNodesMap[171][1], NearestNodesMap[171][2], NearestNodesMap[171][3])
