...
public:
    void TestCollapseCode() throw(Exception)
    {
        ...
        double trans = -Length / 2;
            ...
            std::string output_directory = "TestingHetroModifier/";
        ...
        */
        ...
        p_Membrane_modifier->SetBoundaryNode(100);

        // p_Membrane_modifier->SetMembranePropeties(GrowthMaps, 1.5, Hetrogeneous);
