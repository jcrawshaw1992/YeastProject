...
public:
    void TestHetroPlexus() throw(Exception)
    {
        ...
        std::string mesh_file = "/Users/jcrawshaw/docker-polnet-master/PlexusWithLongInlets/Plexus_Clipped.vtu";
        ...
        std::string output_directory = "HeterogeneousPlexusShrunkPlexusToEqui/LongInLets/Refined/EdgeForcesTakenFromLocalNodes__Within_20UnitsDistance_BendingNotChanged/";
