...
public:
    void TestHetroPlexus() throw(Exception)
    {
        ...
        std::string mesh_file = "/Users/jcrawshaw/docker-polnet-master/PlexusNotScalled/Plexus.vtu";
        ...
        std::string output_directory = "CollpasePlexusToInitialConfig/NoBending/";
