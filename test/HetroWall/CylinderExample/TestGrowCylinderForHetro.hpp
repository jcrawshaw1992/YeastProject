...
public:
    void TestSetUpCylinderArchive() throw(Exception)
    {
        ...
        std::string output_dir = "HetroCylinder/";
        ...
        */
        ...
        // GrowthMaps, double Strength, bool Hetrogeneous, double StepSize, double SetupSolve)
        ...
        */
        ...
        // c_vector<double, 3> Point2 = Create_c_vector(0, 0, 29e-6 * scale);
    ...
    void offTestRunningArchieve() throw(Exception)
    {
        ...
        std::string ArchivedDirectory = "HetroCylinder";//"HetroCylinder/";
        OffLatticeSimulation<2, 3>* p_simulator = CellBasedSimulationArchiver<2, OffLatticeSimulation<2, 3>, 3>::Load(ArchivedDirectory, 5);
        ...
        c_vector<double, 3> LowerPlanePoint = Create_c_vector(17e-6 * scale, 0, 0);

       
        double DilationParameter=10;
        double AreaParameter=8;
        double DeformationParamter=9;
        ...
        std::string output_dir = "HetroCylinder/TestingParameters";
