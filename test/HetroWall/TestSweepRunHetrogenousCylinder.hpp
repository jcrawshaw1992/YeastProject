...
public:
    void TestCollapseCode1() throw(Exception)
    {
            double Dt = 1e-2;
            double Step = 1e-9;
            std::string output_directory = "DevelopingCollapsingModifier/RunDt_2/Step16/";
                ...
                */          
                ...
                p_membrane_force->SetupInitialMembrane( (dynamic_cast<MeshBasedCellPopulation<2,3>*>(&(p_simulator->rGetCellPopulation()))->rGetMesh()) , p_simulator->rGetCellPopulation() );
     ...
     void nTestCollapseCode2() throw(Exception)
    {
            double Dt = 1e-3;
            double Step = 1e-16;
            std::string output_directory = "DevelopingCollapsingModifier/RunDt_3/Step16/";
 ...
 void nTestCollapseCode3() throw(Exception)
    {
            double Dt = 1e-2;
            double Step = 1e-15;
            std::string output_directory = "DevelopingCollapsingModifier/RunDt_2/Step15/";
     ...
     void TestCollapseCode4() throw(Exception)
    {
            double Dt = 1e-3;
            double Step = 1e-15;
            std::string output_directory = "DevelopingCollapsingModifier/RunDt_3/Step15/";
 ...
 void nTestCollapseCode5() throw(Exception)
    {
            double Dt = 1e-2;
            double Step = 1e-14;
            std::string output_directory = "DevelopingCollapsingModifier/RunDt_2/Step14/";
     ...
     void TestCollapseCode6() throw(Exception)
    {
            double Dt = 1e-3;
            double Step = 1e-14;
            std::string output_directory = "DevelopingCollapsingModifier/RunDt_3/Step14/";
 ...
 void nTestCollapseCode7() throw(Exception)
    {
            double Dt = 1e-2;
            double Step = 1e-12;
            std::string output_directory = "DevelopingCollapsingModifier/RunDt_2/Step12/";
     ...
     void nTestCollapseCode8() throw(Exception)
    {
            double Dt = 1e-3;
            double Step = 1e-12;
            std::string output_directory = "DevelopingCollapsingModifier/RunDt_3/Step12/";
    ...
    void nTestCollapseCode9() throw(Exception)
    {
            double Dt = 1e-2;
            double Step = 1e-10;
            std::string output_directory = "DevelopingCollapsingModifier/RunDt_2/Step10/";
     ...
     void nTestCollapseCode10() throw(Exception)
    {
            double Dt = 1e-3;
            double Step = 1e-10;
            std::string output_directory = "DevelopingCollapsingModifier/RunDt_3/Step10/";
    ...
    void nTestCollapseCode11() throw(Exception)
    {
            double Dt = 1e-4;
            double Step = 1e-10;
            std::string output_directory = "DevelopingCollapsingModifier/RunDt_4/Step10/";
     ...
     void nTestCollapseCode12() throw(Exception)
    {
            double Dt = 1e-5;
            double Step = 1e-10;
            std::string output_directory = "DevelopingCollapsingModifier/RunDt_5/Step10/";
