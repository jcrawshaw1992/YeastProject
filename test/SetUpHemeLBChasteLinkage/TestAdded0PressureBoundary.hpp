...
public:
 ...
 void TestMiddelLowerCollapsing() throw (Exception)
    {        
        ...
        p_ForceOut->SetUpHemeLBConfiguration(output_dir+"CollapsingLowerBranch_WithOcclusionShortTS/", p_simulator->rGetCellPopulation());
