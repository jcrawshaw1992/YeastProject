...
//         double EndTime = 10;
//         double scale = 1e-2;        
//         std::string output_dir = "TestFlowThroughCollapse/3/";
//         std::string mesh_file = "/home/vascrem/MeshCollection/IdealisedNetwork/IdealMeshWIthCentralCollapse/Symmetric/Mesh3.vtu";
...
//   }
 void TestHemeLBOnNetwork4444() throw (Exception)
    {         
        ...
        double EndTime = 10;
        double scale = 1e-2;        
        std::string output_dir = "TestFlowThroughCollapse/0/";
        std::string mesh_file = "/home/vascrem/MeshCollection/IdealisedNetwork/IdealMeshWIthCentralCollapse/Symmetric/Mesh1.vtu";
        VtkMeshReader<2, 3> mesh_reader(mesh_file);
        MutableMesh<2, 3> mesh;
        mesh.ConstructFromMeshReader(mesh_reader);
        mesh.Scale(scale,scale,scale);
