...
public:
  ...
  void offTestWithHemeLBForce() throw(Exception)
   {
        ...
        std::string output_dir = "FSISimulations/VascularNetworkLargerBendingForce/Type1Collapse/F/";
        ...
        */
        ...
        // Upstream 
        c_vector<double, 3> UpperPlanePoint =  Create_c_vector(0.10184504656238487, 0.13785209289110795,  0 ); 
        c_vector<double, 3> UpperPlaneNormal = Create_c_vector(0.9714176214585617, -0.2373769254156573,0 );  
        // Down stream
        c_vector<double, 3> LowerPlanePoint = Create_c_vector(0.12909626952677228, 0.12736094344058924,0); 
        c_vector<double, 3> LowerPlaneNormal = -Create_c_vector(0.6626000025670346,-0.7407798752323628, 0 ); 
  ...
  void TestType2Collapse() throw(Exception)
   {
        ...
        /////////////////////////////////////////////////////////////////////////////////////
        //  std::string Archieved = "FSISimulations/VascularNetworkLargerBendingForce/GrowingToEqui/ConstantForceArchiving/";//
        std::string Archieved = "FSISimulations/VascularNetworkLargerBendingForce/Type1Collapse/F";
        std::string output_dir = "FSISimulations/VascularNetworkLargerBendingForce/Type2Collapse/F/";
        // this simulaiton is in mm. Have chosen this magnitude because um in m will give me numbers too close to machince presision, and movment
        // in um will be too large and break chaste without carefull playing with or a tiny time step
  ...
  void offTestType2Collapse() throw(Exception)
   {
  ...
  void offTestWithHemeLBForceFine() throw(Exception)
   {
        ...
        /////////////////////////////////////////////////////////////////////////////////////
        std::string output_dir = "FSISimulations/VascularNetworkLargerBendingForce/Type1Collapse/F/MeshCorrection/";
        std::string Archieved = "FSISimulations/VascularNetworkLargerBendingForce/Type1Collapse/F";
        // this simulaiton is in mm. Have chosen this magnitude because um in m will give me numbers too close to machince presision, and movment
        // in um will be too large and break chaste without carefull playing with or a tiny time step
