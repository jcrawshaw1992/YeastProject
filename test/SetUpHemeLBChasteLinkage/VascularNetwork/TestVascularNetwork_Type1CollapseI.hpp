  ...
  void offTestWithHemeLBForce() throw(Exception)
   {
        ...
        std::string output_dir = "FSISimulations/VascularNetworkLargerBendingForce/Type1Collapse/I/";
        ...
        */
        ...
        // Upstream 
        c_vector<double, 3> UpperPlanePoint =  Create_c_vector( 0.09230849169075055,0.1592397175850668 ,0 ); 
        c_vector<double, 3> UpperPlaneNormal = Create_c_vector(0.726520826104566, 0.6871444456854314 , 0);  
        // Down stream
        c_vector<double, 3> LowerPlanePoint = Create_c_vector(0.1128432639564114, 0.17970564448240475,5.2974933641693225e-5 ); 
        c_vector<double, 3> LowerPlaneNormal = -Create_c_vector(0.4005554443626192, 0.9143556412411801, 0.05923763433743128 ); 
 ...
 void TestWithHemeLBForce() throw(Exception)
   {
        ...
        /////////////////////////////////////////////////////////////////////////////////////
        std::string output_dir = "FSISimulations/VascularNetworkLargerBendingForce/Type1Collapse/I/MeshCorrection/";
        std::string Archieved = "FSISimulations/VascularNetworkLargerBendingForce/Type1Collapse/I";
          // this simulaiton is in mm. Have chosen this magnitude because um in m will give me numbers too close to machince presision, and movment
        // in um will be too large and break chaste without carefull playing with or a tiny time step
