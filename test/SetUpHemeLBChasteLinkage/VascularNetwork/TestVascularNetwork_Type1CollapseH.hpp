...
public:
  ...
  void TestType2Collapse() throw(Exception)
   {
        ...
        */
        ...
        //       // Thirdcollapse option 
        // // Upstream 
        UpperPlanePoint =  Create_c_vector( 0.1510180249914761,0.14078085180508287, -0.0012859092422859055  ); 
        UpperPlaneNormal = Create_c_vector(0.8688521227222457, 0.4936105314126796, -0.03800831645232111);  
        // Down stream
        LowerPlanePoint = Create_c_vector( 0.2471372507737864, 0.19538791424595905, -0.005490686850746726); 
        LowerPlaneNormal = -Create_c_vector(0.8688521227222457, 0.4936105314126796, -0.03800831645232111);  


        boost::shared_ptr<EnclosedRegionBoundaryCondition<2, 3> > p_condition(new EnclosedRegionBoundaryCondition<2, 3>(&(p_simulator->rGetCellPopulation()) , UpperPlanePoint, UpperPlaneNormal, 30)); //0.01));
  ...
  void offTestType2Collapse2() throw(Exception)
   {
