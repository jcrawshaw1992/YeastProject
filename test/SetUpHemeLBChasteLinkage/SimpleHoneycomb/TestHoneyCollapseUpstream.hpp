...
void TestHemeLBCollapse() throw(Exception)
   {
        ...
        std::string output_dir = "FSISimulations/Honey/CollapseUpstreamVessels8/";
        ...
        std::string Archieved = "FSISimulations/Honey/CollapseUpstreamVessels7/"; 
