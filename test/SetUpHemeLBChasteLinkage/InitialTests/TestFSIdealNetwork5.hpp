 ...
 void offTestCylinger() throw (Exception)
    {
        double startime =0;
        double EndTime = 400;     
        std::string output_dir = "FSIIdealNetwork/ArrogantTimeStep/Cylinder/";
  ...
  void TestGrowToEqui4() throw (Exception)
    {
        double startime =0;
        double EndTime = 400;
        double scale = 1e1;//1e-3;  
        double scale2 =  0.15;
        std::string output_dir = "FSIIdealNetwork/ArrogantTimeStep/SimpleBifucation4/";
...
void TestGrowToEqui3() throw (Exception)
    {
        double startime =0;
        double EndTime = 400;
        double scale = 1e1;//1e-3;  
        double scale2 =  0.15;
        std::string output_dir = "FSIIdealNetwork/ArrogantTimeStep/SimpleBifucation3/";
        std::string mesh_file = "/Users/jcrawshaw/Documents/Projects/MeshCollection/SimpleBifucation/mesh.vtu";
  ...
  void TestGrowToEqui2() throw (Exception)
    {
        double startime =0;
        double EndTime = 400;
        double scale = 1e1;//1e-3;  
        double scale2 =  0.15;
        std::string output_dir = "FSIIdealNetwork/ArrogantTimeStep/SimpleBifucation2/";
        std::string mesh_file = "/Users/jcrawshaw/Documents/Projects/MeshCollection/SimpleBifucation/mesh.vtu";
