  ...
  void TestGrowToEqui4() throw (Exception)
    {
        ...
        double scale2 =  0.15;
        std::string output_dir = "FSIIdealNetwork/SimpleBifucation4/Bending1/";
...
void TestGrowToEqui3() throw (Exception)
    {
        ...
        double scale = 1e1;//1e-3;  
        double scale2 =  0.15;
        std::string output_dir = "FSIIdealNetwork/SimpleBifucation3/Bending1/";
        std::string mesh_file = "/Users/jcrawshaw/Documents/Projects/MeshCollection/SimpleBifucation/mesh.vtu";
  ...
  void TestGrowToEqui2() throw (Exception)
    {
        ...
        double scale = 1e1;//1e-3;  
        double scale2 =  0.15;
        std::string output_dir = "FSIIdealNetwork/SimpleBifucation2/Bending1/";
        std::string mesh_file = "/Users/jcrawshaw/Documents/Projects/MeshCollection/SimpleBifucation/mesh.vtu";
