...
public:
    ...
    void TestFSICylinder_HeteroContinoued() throw(Exception)
    {
        std::string output_dir = "FSICylinder/Medium/Hetero/Continued/";
        std::string Archieve = "FSICylinder/Medium/Hetero";
