...
void TestHemeLBOnNetwork() throw (Exception)
    {         
        ...
        double EndTime = 10;
        double scale = 1e-2;        
        std::string output_dir = "TestFlowThroughCollapse/5/";
        std::string mesh_file = "/home/vascrem/MeshCollection/HemeLBMeshes/Mesh5.vtu";
  ...
  void TestHemeLBOnNetwork2() throw (Exception)
    {         
        ...
        double EndTime = 10;
        double scale = 1e-2;        
        std::string output_dir = "TestFlowThroughCollapse/4/";
