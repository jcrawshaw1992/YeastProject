...
void TestHemeLBOnNetwork() throw (Exception)
    {         
        ...
        double EndTime = 10;
        double scale = 1e-2;        
        std::string output_dir = "TestFlowThroughCollapse/2/";
        std::string mesh_file = "/home/vascrem/MeshCollection/HemeLBMeshes/Mesh2.vtu";
  ...
  void TestHemeLBOnNetwork2() throw (Exception)
    {         
        ...
        double EndTime = 10;
        double scale = 1e-2;        
        std::string output_dir = "TestFlowThroughCollapse/1/";
        std::string mesh_file = "/home/vascrem/MeshCollection/HemeLBMeshes/Mesh1.vtu";
    ...
    {         
        ...
        double EndTime = 10;
        double scale = 1e-2;        
        std::string output_dir = "TestFlowThroughCollapse/9/";
        std::string mesh_file = "/home/vascrem/MeshCollection/HemeLBMeshes/Mesh9.vtu";
