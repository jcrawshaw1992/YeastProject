...
void offTestDeformationOfHoneyCombNetworkHomo() throw (Exception)
    {        
...
void TestDeformationOfHoneyCombNetworkHetro() throw (Exception)
   {        
        std::string mesh_file = "/Users/jcrawshaw/docker-polnet-master/IdealiseNetworks/Mesh.vtu";
        std::string output_dir = "HoneyCombNetwork/Hetro2/";
      ...
      // Create the cells 
        ...
        */  
        boost::shared_ptr<RemeshingTriggerOnHeteroMeshModifier<2, 3> > p_Mesh_modifier(new RemeshingTriggerOnHeteroMeshModifier<2, 3>());
          ...
          c_vector<double, 3> UpperPlanePoint = Create_c_vector(0.33,0,0);
          ...
          UpperPlaneNormal = Create_c_vector(1,0,0);
          UpperPlanePoint = Create_c_vector(0.03,0,0);
          LowerPlanePoint = Create_c_vector(0.04,0,0);
          LowerPlaneNormal = Create_c_vector(-1,0,0);
          p_Mesh_modifier->Boundaries( UpperPlaneNormal,  UpperPlanePoint,  LowerPlaneNormal,  LowerPlanePoint);

          UpperPlaneNormal = Create_c_vector(1,0,0);
          UpperPlanePoint = Create_c_vector(0.19,0,0);
          LowerPlanePoint = Create_c_vector(0.21,0,0);
          LowerPlaneNormal = Create_c_vector(-1,0,0);
          p_Mesh_modifier->Boundaries( UpperPlaneNormal,  UpperPlanePoint,  LowerPlaneNormal,  LowerPlanePoint);
