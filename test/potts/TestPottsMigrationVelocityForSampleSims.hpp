      ...
      // Randomly select three nodes. 
        ...
        */
        ...
        /////////////////////////////
            ...
            potts_simulator.SetOutputDirectory("PottsMetrics/Migration/Sample_0.01/");
      ...
      // Randomly select three nodes. 
        ...
        */
        ...
        potts_simulator.AddSimulationModifier(p_modifier);
            ...
            potts_simulator.SetOutputDirectory("PottsMetrics/Migration/Sample_0.05/" );
            potts_simulator.SetSamplingTimestepMultiple(1);
            potts_simulator.SetEndTime(100);
...
void noTestNonperiodicPotts3()
    {
      ...
      // Randomly select three nodes. 
        ...
        */
        ...
        potts_simulator.SetOutputDirectory("PottsMetrics/Migration/Sample+0.1/Trail" );
        potts_simulator.SetSamplingTimestepMultiple(1);
        potts_simulator.SetEndTime(100);
      ...
      // Randomly select three nodes. 
        ...
        */
        ...
        potts_simulator.AddSimulationModifier(p_modifier);
            ...
            potts_simulator.SetOutputDirectory("PottsMetrics/Migration/Sample_0.5/");
            potts_simulator.SetSamplingTimestepMultiple(1);
            potts_simulator.SetEndTime(100);
      ...
      // Randomly select three nodes. 
        ...
        */
        ...
        potts_simulator.AddSimulationModifier(p_modifier);
            ...
            potts_simulator.SetOutputDirectory("PottsMetrics/Migration/Sample_1/");
            potts_simulator.SetSamplingTimestepMultiple(1);
            potts_simulator.SetEndTime(100);
 ...
 void TestNonperiodicPottsfff()
    {
		...
		*/
            ...
            */
            ...
            potts_simulator.SetOutputDirectory("PottsMetrics/Migration/Sample_5/" );
            potts_simulator.SetSamplingTimestepMultiple(1);
