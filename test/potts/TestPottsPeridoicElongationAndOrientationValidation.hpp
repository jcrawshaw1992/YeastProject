        ...
        for (double k = 2; k > -4; k--)
        {
            for (double j = 2; j > -4; j--)
            {
                ...
                for (int i = 0; i < 500; i++)
                {
                    ...
                    potts_population.AddCellWriter<CellSecAspectRatioWriter>();
                    potts_population.AddCellWriter<CellMajorAxisAngleWriter>();
                    potts_population.AddCellWriter<CellOrientationWriter>();
                    ...
                    /*
                    *  Add Elongation_and_Orientation
                    */
                    ...
                    p_aspect_ratio_update_rule->SetAspectRatioEnergyParameter(pow(10, k));
                    p_aspect_ratio_update_rule->SetOrientationParameter(pow(10, j));
                    ...
                    potts_simulator.SetOutputDirectory("PottsMetrics/Periodic/Elongationa_And_Orientation_test/" + Parameters + "/Trial" + Iteration);
