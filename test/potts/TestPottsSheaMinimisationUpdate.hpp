...
void TestNonperiodicPotts()
    {
      ...
      // Randomly select three nodes. 
        ...
        MAKE_PTR(MinimiseShearStressUpdateRule<3>, p_ShearMinimisation_update_rule);
		p_ShearMinimisation_update_rule->SetShearMinimisationCorrelationParameter(16 / 1);
		potts_simulator.AddUpdateRule(p_ShearMinimisation_update_rule);
        ...
        */
        ...
        potts_simulator.AddSimulationModifier(p_modifier);
            ...
            potts_simulator.SetOutputDirectory("PottsMetrics/ShearMinimisation" );
