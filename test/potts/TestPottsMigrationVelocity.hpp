     ...
     void TestNonperiodicPotts1()
    {
      ...
      // Randomly select three nodes. 
        ...
        */
		 ...
		 p_mechanotaxis_update_rule->SetTractionCorrelationParameter(0.01);// that is stupidly big ---  Works for ---  update rule 
        ...
        /////////////////////////////
            ...
            potts_simulator.SetOutputDirectory("PottsMetrics/Migration/TractionParameter_0.01/Trail"+Iteration );
            potts_simulator.SetSamplingTimestepMultiple(10);
            potts_simulator.SetEndTime(100);
      ...
      // Randomly select three nodes. 
        ...
        */
        ...
        /////////////////////////////
            ...
            potts_simulator.SetOutputDirectory("PottsMetrics/Migration/TractionParameter_0.05/Trail"+Iteration );
            potts_simulator.SetSamplingTimestepMultiple(10);
            potts_simulator.SetEndTime(100);
      ...
      // Randomly select three nodes. 
        ...
        */
        ...
        /////////////////////////////
            ...
            potts_simulator.SetOutputDirectory("PottsMetrics/Migration/TractionParameter_0.1/Trail"+Iteration );
            potts_simulator.SetSamplingTimestepMultiple(10);
            potts_simulator.SetEndTime(100);
...
void TestNonperiodicPotts4()
    {
      ...
      // Randomly select three nodes. 
        ...
        */
         ...
         MAKE_PTR(MechanotaxisPottsWrappedUpdateRule<3>, p_mechanotaxis_update_rule);
		 p_mechanotaxis_update_rule->SetTractionCorrelationParameter(0.5);// that is stupidly big ---  Works for ---  update rule 
        potts_simulator.AddUpdateRule(p_mechanotaxis_update_rule);
        ...
        /////////////////////////////
            ...
            potts_simulator.SetOutputDirectory("PottsMetrics/Migration/TractionParameter_0.5/Trail"+Iteration );
            potts_simulator.SetSamplingTimestepMultiple(10);
            potts_simulator.SetEndTime(100);
   ...
   void TestNonperiodicPottsddddd()
    {
         MathsFunctions M;;
      ...
      // Randomly select three nodes. 
        ...
        */
         ...
         MAKE_PTR(MechanotaxisPottsWrappedUpdateRule<3>, p_mechanotaxis_update_rule);
		 p_mechanotaxis_update_rule->SetTractionCorrelationParameter(1);// that is stupidly big ---  Works for ---  update rule 
        potts_simulator.AddUpdateRule(p_mechanotaxis_update_rule);
        ...
        /////////////////////////////
          std::stringstream out;
            ...
            potts_simulator.SetOutputDirectory("PottsMetrics/Migration/TractionParameter_1/Trail"+Iteration );
            potts_simulator.SetSamplingTimestepMultiple(10);
            potts_simulator.SetEndTime(100);
		...
		*/
        ...
        for (int i =0;i<500; i++)
        {
            ...
            */
                ...
                MAKE_PTR(MechanotaxisPottsWrappedUpdateRule<3>, p_mechanotaxis_update_rule);
                p_mechanotaxis_update_rule->SetTractionCorrelationParameter(5);// that is stupidly big ---  Works for ---  update rule 
            potts_simulator.AddUpdateRule(p_mechanotaxis_update_rule);
            ...
            potts_simulator.SetOutputDirectory("PottsMetrics/Migration/TractionParameter_5/Trail"+Iteration );
            potts_simulator.SetSamplingTimestepMultiple(10);
            potts_simulator.SetEndTime(50);
