...
public:
    ...
    void offTestRemeshingCylinder_CoarseInitial() throw(Exception)
    {
        ...
        while (EdgeLength > 0.03)
        {
            ...
            std::vector<double> quartiles = Quantile<double>(Error, { 0, 0.5, 1 });
            typename std::vector<double>::iterator Iterator = quartiles.begin();
            double Quartile1 = *min_element(Error.begin(), Error.end());
            std::advance(Iterator, 1);
            double Med = *Iterator;
            std::advance(Iterator, 1);
            double Quartile3 = *max_element(Error.begin(), Error.end());
        ...
        std::ofstream f("/Users/jcrawshaw/Documents/Projects/MeshMatlab/Remeshing3D/RawSpatialErrorData/MaxAndMinData/SpatialErrorAnal_3D_CoarseInitial_20oct.txt");
    ...
    void TestRemeshingCylinder_FineInitial() throw(Exception)
    {
        ...
        std::ofstream f("/Users/jcrawshaw/Documents/Projects/MeshMatlab/Remeshing3D/RawSpatialErrorData/MaxAndMinData/SpatialErrorAnal_3D_FineInitial_20oct.txt");
        for (std::vector<double>::iterator i = EdgeL.begin(); i != EdgeL.end(); ++a, ++b, ++c, ++i)
        {
            f << *i << " " << *b << " " << *a << " " << *c << '\n';
        }
    ...
    void TestRemeshingCylinder_FineRemeshed() throw(Exception)
    {
        ...
        std::ofstream f("/Users/jcrawshaw/Documents/Projects/MeshMatlab/Remeshing3D/RawSpatialErrorData/MaxAndMinData/SpatialErrorAnal_3D_FineRemeshed_20oct.txt");
        for (std::vector<double>::iterator i = EdgeL.begin(); i != EdgeL.end(); ++a, ++b, ++c, ++i)
        {
            f << *i << " " << *b << " " << *a << " " << *c << '\n';
        }
    ...
    void TestRemeshingCylinder_CourseRemeshed() throw(Exception)
    {
        ...
        std::ofstream f("/Users/jcrawshaw/Documents/Projects/MeshMatlab/Remeshing3D/RawSpatialErrorData/MaxAndMinData/SpatialErrorAnal_3D_CoarseRemeshed_20oct.txt");
