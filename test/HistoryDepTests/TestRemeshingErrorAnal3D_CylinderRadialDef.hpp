 ...
 void offTestCreateCylinder() throw(Exception)
    {
        ...
        std::string output_directory = "RemeshingErrorAnal3D/Cylinder_RadialDef";
    ...
    void TestRemeshingCylinder_CourseInitial_VMTK() throw(Exception)
    {
        ...
        double EdgeLength = 2;
        double Iter = 10;
        std::string output_dir = "~/Documents/testoutput/RemeshingErrorAnal3D/Cylinder_RadialDef/VMTK/";
        double startime = 0;
        ...
        std::string RemeshCommand = "vmtksurfaceremeshing -ifile " + stlfile + " -iterations " + std::to_string(20) + " -edgelength "+ std::to_string(1) +" -ofile " + Remeshedstl + " -elementsizemode edgelength";
        ...
        while (EdgeLength > 0.01)
        {
            ...
            std::string mesh_file = "/Users/jcrawshaw/Documents/testoutput/RemeshingErrorAnal3D/Cylinder_RadialDef/VMTK/CourseInital/RemeshedCylinder.vtu";
            ...
            output_dir = "RemeshingErrorAnal3D/Cylinder_RadialDef/VMTK/CourseInital/EdgeLength/" + mesh_size;
    ...
    void TestRemeshingCylinder_FineInitial_VMTK() throw(Exception)
    {
        ...
        {
            // Read in the new cylinder that is generated to my desire
            std::string mesh_file = "/Users/jcrawshaw/Documents/testoutput/RemeshingErrorAnal3D/Cylinder_RadialDef/VMTK/FineInital/RemeshedCylinder.vtu";
            VtkMeshReader<2, 3> mesh_reader(mesh_file);
            HistoryDepMutableMesh<2, 3> mesh;
            mesh.ConstructFromMeshReader(mesh_reader);
            ...
            out << EdgeLength;
            std::string mesh_size = out.str();
            output_dir = "RemeshingErrorAnal3D/Cylinder_RadialDef/VMTK/FineInital/EdgeLength/" + mesh_size;
            ...
            output_dir = "~/Documents/testoutput/RemeshingErrorAnal3D/Cylinder_RadialDef/VMTK/FineInital/EdgeLength/" + mesh_size;
            // Convert the 4 meshes I need off to stl
            std::string ConvertCommand = "meshio-convert " + output_dir + "/InitalOriginalMesh.vtu " + output_dir + "/InitalOriginalMesh.stl";
            std::system(ConvertCommand.c_str()); // system only takes char *
            ConvertCommand = "meshio-convert " + output_dir + "/DeformedRemeshedMesh.vtu " + output_dir + "/DeformedRemeshedMesh.stl";
        ...
        std::ofstream f("/Users/jcrawshaw/Documents/Projects/MeshMatlab/ErrorAnal_Cylinder_RadiaDef_FineInitial.txt");
        for (std::vector<double>::iterator i = RootMeanSquared.begin(); i != RootMeanSquared.end(); ++j, ++k, ++l, ++i)
        {
            f << *k << " " << *i << " " << *j << " " << *l << '\n';
        }
    ...
    void TestRemeshingCylinder_CourseRemeshedMesh_VMTK() throw(Exception)
    {
        ...
        while (EdgeLength > 0.01)
        {
            ...
            // Read in the new cylinder that is generated to my desire
            std::string mesh_file = "/Users/jcrawshaw/Documents/testoutput/RemeshingErrorAnal3D/Cylinder_RadialDef/VMTK/CourseRemeshed/EdgeLength/" + mesh_size + "/InitalOriginalMesh.vtu";
            ...
            // out << EdgeLength;
            // std::string mesh_size = out.str();
            // std::string output_dir = "~/Documents/testoutput/RemeshingErrorAnal3D/Cylinder_RadialDef/VMTK/CourseRemeshed/";
            ...
            // std::string vtu2offCommand = "meshio-convert ~/Documents/testoutput/RemeshingErrorAnal3D/Cylinder_RadialDef/VMTK/Cylinder.vtu " + stlfile;
            // std::system(vtu2offCommand.c_str()); // system only takes char *.
            ...
            std::string output_dir = "RemeshingErrorAnal3D/Cylinder_RadialDef/VMTK/CourseRemeshed/EdgeLength/" + mesh_size;

            // Read in the new cylinder that is generated to my desire
            // std::string mesh_file = "/Users/jcrawshaw/Documents/testoutput/RemeshingErrorAnal3D/Cylinder_RadialDef/VMTK/CourseRemeshed/RemeshedCylinder.vtu";
            VtkMeshReader<2, 3> mesh_reader(mesh_file);
            HistoryDepMutableMesh<2, 3> mesh;
            mesh.ConstructFromMeshReader(mesh_reader);
            ...
            for (int i = 0; i < mesh.GetNumNodes(); i++)
            {
                ...
                double X = R * cos(Angle) *2; //+ InitalLocation[2]-1;
                double Y = R * 2 * sin(Angle);
            ...
            output_dir = "~/Documents/testoutput/RemeshingErrorAnal3D/Cylinder_RadialDef/VMTK/CourseRemeshed/EdgeLength/" + mesh_size;
            // Convert the 4 meshes I need off to stl
            std::string ConvertCommand = "meshio-convert " + output_dir + "/InitalOriginalMesh.vtu " + output_dir + "/InitalOriginalMesh.stl";
            std::system(ConvertCommand.c_str()); // system only takes char *
            ConvertCommand = "meshio-convert " + output_dir + "/DeformedRemeshedMesh.vtu " + output_dir + "/DeformedRemeshedMesh.stl";
        ...
        std::ofstream f("/Users/jcrawshaw/Documents/Projects/MeshMatlab/ErrorAnal_Cylinder_RadiaDef_CourseRemeshsed.txt");;
        for (std::vector<double>::iterator i = RootMeanSquared.begin(); i != RootMeanSquared.end(); ++j, ++k, ++l, ++i)
        {
            f << *k << " " << *i << " " << *j << " " << *l << '\n';
        }
    ...
    void TestRemeshingCylinder_FineRemeshsed_VMTK() throw(Exception)
    {
        ...
        while (EdgeLength > 0.01)
        {
            ...
            std::string output_dir = "RemeshingErrorAnal3D/Cylinder_RadialDef/VMTK/FineRemeshed/EdgeLength/" + mesh_size;
        ...
        std::ofstream f("/Users/jcrawshaw/Documents/Projects/MeshMatlab/ErrorAnal_Cylinder_RadiaDef_FineRemeshsed.txt");
        for (std::vector<double>::iterator i = RootMeanSquared.begin(); i != RootMeanSquared.end(); ++j, ++k, ++l, ++i)
        {
            f << *k << " " << *i << " " << *j << " " << *l << '\n';
        }
