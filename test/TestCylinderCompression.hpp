...
public:
    void TestAreaFroceDragCorrectedEqui() throw(Exception)
    {
        ...
        std::string output_directory = "TestingCompressiveForces";//Shrinking"; // + Parameters + "/";
        ...
        simulator.SetEndTime(1); //(M_TIME_FOR_SIMULATION);
        ...
        */
        ...
        std::string PressureFile = "/Users/jcrawshaw/Documents/ChasteWorkingDirectory/DeformingCylindricalBasicHetroWallTesting/results/Extracted/surface-pressure.xtr";
...
//         */
        ...
        double ElasticShearModulus = 0.5 * 1e-4; //0.5 * 1e-4; // n/m 0.5 * 1e-7;
        double AreaDilationModulus = 1e-8;//1e-9;
        ...
        // p_shear_force->UpdateMembraneProperties(cell_population);
...
//         double Area_constant = 1 * 1e-6;// 1 * 1e-6;
...
//         p_surface_force->UpdateMembraneSurfaceForceProperties(cell_population);
...
//          ----------------------------
//        */
//         double membrane_constant = 1 * 1e-12;
...
//         p_membrane_force->UpdateMembraneStiffnessProperties(cell_population);
