...
public:
    ...
    void TestIntroduceHetro0() throw(Exception)
    {
        ...
        std::string output_dir = "HetroCylinder_p/15/";
        ...
        */
        ...
        p_Mesh_modifier->SetMembranePropeties(GrowthMaps, 1, 1, 1e-15, 1);
    ...
    void TestIntroduceHetro1() throw(Exception)
    {
        ...
        double SamplingTimestepMultiple = 1000;
        std::string output_dir = "HetroCylinder_p/8/";
        ...
        */
        ...
        // Strength,hetro,stepsize, setupsolve
        // GrowthMaps, Strength, Hetrogeneous,  StepSize,SetupSolve
        p_Mesh_modifier->SetMembranePropeties(GrowthMaps, 1, 1, 1e-8, 1);
        p_Mesh_modifier->Boundaries(UpperPlaneNormal,UpperPlanePoint,  LowerPlaneNormal,LowerPlanePoint );
        p_Mesh_modifier->SetBasementMembraneStrength(0);
        p_Mesh_modifier->SetPlateauParameters(8, 2);
     ...
     void TestIntroduceHetro2() throw(Exception)
    {
        ...
        double SamplingTimestepMultiple = 1000;
        std::string output_dir = "HetroCylinder_P/12/";
        ...
        */
        ...
        // Strength,hetro,stepsize, setupsolve
        // GrowthMaps, Strength, Hetrogeneous,  StepSize,SetupSolve
        p_Mesh_modifier->SetMembranePropeties(GrowthMaps, 1, 1, 1e-12, 1);
        p_Mesh_modifier->Boundaries(UpperPlaneNormal,UpperPlanePoint,  LowerPlaneNormal,LowerPlanePoint );
        p_Mesh_modifier->SetBasementMembraneStrength(0);
        p_Mesh_modifier->SetPlateauParameters(8, 2);
