...
static const double M_TIME_FOR_SIMULATION = 50; //40; //50
...
public:
    void TestBendingForceParameterSweep2() throw(Exception)
    {
        ...
        double Length = 4e-6 * scale; //12e-3; //12e-3
       ...
       for (unsigned KA_index = 0; KA_index <9; KA_index++)
        {
            ...
            for (unsigned KAlpha_index = 0; KAlpha_index <9; KAlpha_index++)
            {
                    ...
                    std::string output_directory = "ChasteMembraneParameterSweep/Ks12/" + mesh_size;
        ...
        */
                    ...
                    double TransmuralPressure = 1.066e4 ;//6.6715e-04;//P_blood - P_tissue;
                    ...
                    ----------------------------
                    */
                    double membrane_constant = 10 ;//1e-11;
                    ...
                    */
                    ...
                    c_vector<long double, 3> Boundary1 = Create_c_vector(0, 0, -2e-6 * scale);
                    c_vector<long double, 3> Normal1 = Create_c_vector(0, 0, 1);

                    c_vector<long double, 3> Boundary2 = Create_c_vector(0, 0, 2e-6 * scale);
