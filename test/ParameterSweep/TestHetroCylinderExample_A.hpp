...
public:
    ...
    void offTestRunningArchieve3() throw(Exception)
    {

        // std::string Archieved = ;
        OffLatticeSimulation<2, 3>* p_simulator = CellBasedSimulationArchiver<2, OffLatticeSimulation<2, 3>, 3>::Load("HetroCylinder", 7);
        // Load and fix any settings in the simulator
     ...
     void TestIntroduceHetro2() throw(Exception)
    {
        ...
        double SamplingTimestepMultiple = 100;
        std::string output_dir = "HetroCylinder/A_12/";
     ...
     void TestIntroduceHetro3() throw(Exception)
    {
        ...
        double SamplingTimestepMultiple = 100;
        std::string output_dir = "HetroCylinder/A_4/";
