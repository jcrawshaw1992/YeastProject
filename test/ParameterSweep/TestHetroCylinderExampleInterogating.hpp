...
public:
    ...
    //     std::string output_dir = "HetroCylinder/TryingToFindProblem/";
    ...
    //     std::string output_dir = "HetroCylinder/b_0.02/";
    ...
    //     p_Mesh_modifier->Boundaries(UpperPlaneNormal,UpperPlanePoint,  LowerPlaneNormal,LowerPlanePoint );
    //     p_Mesh_modifier->SetBasementMembraneStrength(0);
    //     p_Mesh_modifier->SetPlateauParameters(8,0.02);
    //     p_Mesh_modifier->SetUpdateFrequency(50);
 ...
 void offTestIntroduceHetro3() throw(Exception)
    {
        std::string Archieved = "HetroCylinder/Testting/";
        OffLatticeSimulation<2, 3>* p_simulator = CellBasedSimulationArchiver<2, OffLatticeSimulation<2, 3>, 3>::Load(Archieved, 11);
        ...
        std::string output_dir = "HetroCylinder/Testting/";
     ...
     void offTestIntroduceHetro3() throw(Exception)
    {
        ...
        */
        ...
        p_Mesh_modifier->SetBasementMembraneStrength(0);
        p_Mesh_modifier->SetPlateauParameters(8,2);
        p_Mesh_modifier->SetUpdateFrequency(80);
