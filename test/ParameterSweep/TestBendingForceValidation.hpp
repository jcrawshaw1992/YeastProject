...
static const double M_TIME_FOR_SIMULATION = 1000; 
static const double M_TIME_STEP = 0.02; 
static const double M_SAMPLING = 500; 
     ...
     void TestCylinderSquahsed() throw (Exception)
    {
        ...
        for (unsigned N_D_index = 0; N_D_index < 3; N_D_index++)
        {
            double N_Z =  N_D[N_D_index] *3;
                ...
                std::string output_directory = "BendingValidation/Squashed/" + mesh_size;
...
//                 */
//                 boost::shared_ptr<MembraneStiffnessForce> p_membrane_force(new MembraneStiffnessForce());
//                 p_membrane_force->SetMembraneStiffness(M_BendingConstant);
...
//         }
//     }
// void NoTestCylinderImposedPressureWithRandomMeshes() throw (Exception)
//     {
...
//             std::string output_directory = "BendingValidation/Random/" + mesh_size;
...
//                 out << N_D[N_D_index] << "_" << N_Z;
//                 std::string mesh_size = out.str();
//                 std::string output_directory = "BendingValidation/Equi/" + mesh_size;
