#ifndef FixedRegionBoundaryConditionWithMutationWithMutation_HPP_
#define FixedRegionBoundaryConditionWithMutationWithMutation_HPP_
...
class FixedRegionBoundaryConditionWithMutation : public AbstractCellPopulationBoundaryCondition<ELEMENT_DIM,SPACE_DIM>
{
private:
...
public:
     ...
     */
    FixedRegionBoundaryConditionWithMutation(AbstractCellPopulation<ELEMENT_DIM,SPACE_DIM>* pCellPopulation,
...
{
/**
 * Serialize information required to construct a FixedRegionBoundaryConditionWithMutation.
 */
template<class Archive, unsigned ELEMENT_DIM, unsigned SPACE_DIM>
inline void save_construct_data(
    Archive & ar, const FixedRegionBoundaryConditionWithMutation<ELEMENT_DIM,SPACE_DIM>* t, unsigned int file_version)
{
...
/**
 * De-serialize constructor parameters and initialize a FixedRegionBoundaryConditionWithMutation.
 */
template<class Archive, unsigned ELEMENT_DIM, unsigned SPACE_DIM>
inline void load_construct_data(
    Archive & ar, FixedRegionBoundaryConditionWithMutation<ELEMENT_DIM,SPACE_DIM>* t, const unsigned int file_version)
{
    ...
    ::new(t)FixedRegionBoundaryConditionWithMutation<ELEMENT_DIM,SPACE_DIM>(p_cell_population, point, normal, radius);
}
}
} // namespace ...
