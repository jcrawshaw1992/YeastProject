...
{
    // std::string Remeshedvtu = mChasteOutputDirectory + "RemeshedGeometry.vtu";
     std::string Remeshedvtu = "/data/vascrem/testoutput/ParameterSweepWithRemeshing/Cylinder/RemeshsedParam_10_DilationParam_10_DeformationParam_16/results_from_time_0/RemeshedGeometry.vtu";
