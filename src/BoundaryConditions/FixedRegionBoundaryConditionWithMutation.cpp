#include "FixedRegionBoundaryConditionWithMutation.hpp"
#include "AbstractCentreBasedCellPopulation.hpp"
#include "VertexBasedCellPopulation.hpp"
#include "CellLabel.hpp"
#include "Debug.hpp"
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
FixedRegionBoundaryConditionWithMutation<ELEMENT_DIM,SPACE_DIM>::FixedRegionBoundaryConditionWithMutation(AbstractCellPopulation<ELEMENT_DIM,SPACE_DIM>* pCellPopulation,
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
const c_vector<double, SPACE_DIM>& FixedRegionBoundaryConditionWithMutation<ELEMENT_DIM,SPACE_DIM>::rGetPointOnPlane() const
{
    return mPointOnPlane;
}

template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
const c_vector<double, SPACE_DIM>& FixedRegionBoundaryConditionWithMutation<ELEMENT_DIM,SPACE_DIM>::rGetNormalToPlane() const
{
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
const double& FixedRegionBoundaryConditionWithMutation<ELEMENT_DIM,SPACE_DIM>::rGetRadius() const
{
    return mRadius;
}

template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void FixedRegionBoundaryConditionWithMutation<ELEMENT_DIM,SPACE_DIM>::ImposeBoundaryCondition(const std::map<Node<SPACE_DIM>*, c_vector<double, SPACE_DIM> >& rOldLocations)
{
    ...
    {
        EXCEPTION("FixedRegionBoundaryConditionWithMutation requires a subclass of AbstractOffLatticeCellPopulation.");
    }
    ...
    else
    {
        // SPACE_DIM == 1
        NEVER_REACHED;
        //FixedRegionBoundaryConditionWithMutation::ImposeBoundaryCondition is not implemented in 1D
    }
}

template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
bool FixedRegionBoundaryConditionWithMutation<ELEMENT_DIM,SPACE_DIM>::VerifyBoundaryCondition()
{
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void FixedRegionBoundaryConditionWithMutation<ELEMENT_DIM,SPACE_DIM>::OutputCellPopulationBoundaryConditionParameters(out_stream& rParamsFile)
{
...
template class FixedRegionBoundaryConditionWithMutation<1,1>;
template class FixedRegionBoundaryConditionWithMutation<1,2>;
template class FixedRegionBoundaryConditionWithMutation<2,2>;
template class FixedRegionBoundaryConditionWithMutation<1,3>;
template class FixedRegionBoundaryConditionWithMutation<2,3>;
template class FixedRegionBoundaryConditionWithMutation<3,3>;

// Serialization for Boost >= 1.36
#include "SerializationExportWrapperForCpp.hpp"
EXPORT_TEMPLATE_CLASS_ALL_DIMS(FixedRegionBoundaryConditionWithMutation)
