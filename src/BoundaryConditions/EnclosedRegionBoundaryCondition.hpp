#ifndef EnclosedRegionBoundaryCondition_HPP_
#define EnclosedRegionBoundaryCondition_HPP_
...
class EnclosedRegionBoundaryCondition : public AbstractCellPopulationBoundaryCondition<ELEMENT_DIM,SPACE_DIM>
{
private:
     ...
     * A point on the boundary plane.
     */
    c_vector<double, SPACE_DIM> mPointOnPlane2;

    /**
     * The outward-facing unit normal vector to the boundary plane.
     */
    c_vector<double, SPACE_DIM> mNormalToPlane2;
    ...
    void serialize(Archive & archive, const unsigned int version)
    {
        ...
        archive & mNormalToPlane2;
        archive & mPointOnPlane2;
    }
...
public:
    ...
    const c_vector<double, SPACE_DIM>& rGetPointOnPlane2() const;

    /**
     * @return mNormalToPlane.
     */
    const c_vector<double, SPACE_DIM>& rGetNormalToPlane2() const;
...
{
/**
 * Serialize information required to construct a EnclosedRegionBoundaryCondition.
 */
template<class Archive, unsigned ELEMENT_DIM, unsigned SPACE_DIM>
inline void save_construct_data(
    Archive & ar, const EnclosedRegionBoundaryCondition<ELEMENT_DIM,SPACE_DIM>* t, unsigned int file_version)
{
...
/**
 * De-serialize constructor parameters and initialize a EnclosedRegionBoundaryCondition.
 */
template<class Archive, unsigned ELEMENT_DIM, unsigned SPACE_DIM>
inline void load_construct_data(
    Archive & ar, EnclosedRegionBoundaryCondition<ELEMENT_DIM,SPACE_DIM>* t, const unsigned int file_version)
{
    ...
    ::new(t)EnclosedRegionBoundaryCondition<ELEMENT_DIM,SPACE_DIM>(p_cell_population, point, normal, radius);
}
}
} // namespace ...

#endif /*EnclosedRegionBoundaryCondition_HPP_*/
