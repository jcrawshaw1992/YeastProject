#ifndef FixedRegionBoundaryConditionWithRemeshing_HPP_
#define FixedRegionBoundaryConditionWithRemeshing_HPP_
...
class FixedRegionBoundaryConditionWithRemeshing : public AbstractCellPopulationBoundaryCondition<ELEMENT_DIM,SPACE_DIM>
{
private:
...
public:
     ...
     */
    FixedRegionBoundaryConditionWithRemeshing(AbstractCellPopulation<ELEMENT_DIM,SPACE_DIM>* pCellPopulation,
...
{
/**
 * Serialize information required to construct a FixedRegionBoundaryConditionWithRemeshing.
 */
template<class Archive, unsigned ELEMENT_DIM, unsigned SPACE_DIM>
inline void save_construct_data(
    Archive & ar, const FixedRegionBoundaryConditionWithRemeshing<ELEMENT_DIM,SPACE_DIM>* t, unsigned int file_version)
{
...
/**
 * De-serialize constructor parameters and initialize a FixedRegionBoundaryConditionWithRemeshing.
 */
template<class Archive, unsigned ELEMENT_DIM, unsigned SPACE_DIM>
inline void load_construct_data(
    Archive & ar, FixedRegionBoundaryConditionWithRemeshing<ELEMENT_DIM,SPACE_DIM>* t, const unsigned int file_version)
{
    ...
    ::new(t)FixedRegionBoundaryConditionWithRemeshing<ELEMENT_DIM,SPACE_DIM>(p_cell_population, point, normal, radius);
}
}
} // namespace ...

#endif /*FixedRegionBoundaryConditionWithRemeshing_HPP_*/
