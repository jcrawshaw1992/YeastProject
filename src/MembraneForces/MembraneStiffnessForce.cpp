...
// PRINT_VARIABLE(angle );
        ...
        // MembraneStiffness += p_cell1->GetCellData()->GetItem("BendingConstant");
        ...
        // if (p_cell1->GetCellData()->GetItem("Boundary") ==1 )
        // {
        //     node1_contribution *=0;
        // }
        //  if (p_cell2->GetCellData()->GetItem("Boundary") ==1 )
        // {
        //     node1_contribution *=0;
        // }
        //  if (p_cell3->GetCellData()->GetItem("Boundary") ==1 )
        // {
        //     node1_contribution *=0;
        // }
        //  if (p_cell4->GetCellData()->GetItem("Boundary") ==1 )
        // {
        //     node1_contribution *=0;
        // }
