...
CylinderOutwardsPressure::CylinderOutwardsPressure()
        : AbstractForce<2, 3>()
{
}

void CylinderOutwardsPressure::SetPressure(double Pressure)
{
      mStrength =  Pressure;
}


void CylinderOutwardsPressure::AddForceContribution(AbstractCellPopulation<2, 3>& rCellPopulation)
{
...
void CylinderOutwardsPressure::OutputForceParameters(out_stream& rParamsFile)
{
