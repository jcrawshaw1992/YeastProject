...
MembraneBendingForceSensitive::MembraneBendingForceSensitive()
   : AbstractForce<2,3>(),
     mMembraneStiffness(1)
{
}

void MembraneBendingForceSensitive::SetMembraneStiffness(double membraneStiffnes)
{
    mMembraneStiffness = membraneStiffnes;
}

// double MembraneBendingForceSensitive::GetMembraneStiffness() const
// {
// 	return mMembraneStiffness;
// }

// double MembraneBendingForceSensitive::GetOriginalAngle(std::pair<Node<3>*, Node<3>*> edge)
// {
//     return mOriginalAngles.at(std::pair<unsigned,unsigned>(edge.first->GetIndex(),edge.second->GetIndex()));
// }

// double MembraneBendingForceSensitive::SetOriginalAngle(std::pair<Node<3>*, Node<3>*> edge, double angle)
// {
//     mOriginalAngles[std::pair<unsigned,unsigned>(edge.first->GetIndex(),edge.second->GetIndex())] = angle;
// }

bool MembraneBendingForceSensitive::CalculateElementNormals(MutableMesh<2, 3>& rMesh, std::pair<Node<3>*, Node<3>*> edge,
...
void MembraneBendingForceSensitive::AddForceContribution(AbstractCellPopulation<2,3>& rCellPopulation)
{
...
void MembraneBendingForceSensitive::OutputForceParameters(out_stream& rParamsFile)
{
...
// void MembraneBendingForceSensitive::SetupInitialMembrane(MutableMesh<2,3>& rMesh, AbstractCellPopulation<2, 3>& rCellPopulation)
// {
...
// bool MembraneBendingForceSensitive::CalculateElementNormalsInital(MutableMesh<2, 3>& rMesh, std::pair<Node<3>*, Node<3>*> edge,
//                                                      std::pair<c_vector<double, 3>, c_vector<double, 3> >& nonUnitNormals,
//                                                      std::pair<Node<3>*,  Node<3>*>& otherNodes,
