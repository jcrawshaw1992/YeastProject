...
#ifndef MembraneDeformationForce_HPP_
#define MembraneDeformationForce_HPP_
 ...
 */
class MembraneDeformationForce : public AbstractForce<2, 3>
...
#endif /*MembraneDeformationForce_HPP_*/
