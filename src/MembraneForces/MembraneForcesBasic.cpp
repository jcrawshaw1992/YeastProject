...
MembraneForcesBasic::MembraneForcesBasic()
        : AbstractForce<2, 3>()
{
}
   ...
   MeshBasedCellPopulation<2, 3>* p_cell_population = static_cast<MeshBasedCellPopulation<2, 3>*>(&rCellPopulation);
    ...
    for (AbstractCellPopulation<2, 3>::Iterator cell_iter = rCellPopulation.Begin();
            ...
            ++cell_iter)
        {
            ...
            cell_iter->GetCellData()->SetItem("ShearMod",0);
            cell_iter->GetCellData()->SetItem("AreaMod",0);
         ...
         ++elem_iter)
    {
        ...
        c_vector<c_vector<double, 2>, 3> InitialVectors = mInitalVectors[elem_index];
        ...
        c_vector<double, 3> a_i = mACoefficients[elem_index];
        c_vector<double, 3> b_i = mBCoefficients[elem_index];
        ...
        c_vector<c_vector<double, 3>, 3> AreaForceOnNode_TEMP;
          ...
          for (int i = 0; i < 3; i++)
        {
            node_index = elem_iter->GetNodeGlobalIndex(i);
            p_cell = p_cell_population->GetCellUsingLocationIndex(node_index);
            double ShearMode = norm_2(ForceOnNode[i]) +  p_cell->GetCellData()->GetItem("ShearMod");
            p_cell->GetCellData()->SetItem("ShearMod",ShearMode );
...
c_vector<c_vector<double, 3>, 3> MembraneForcesBasic::MatrixMultiplication(c_vector<c_vector<double, 3>, 3> Matrix1, c_vector<c_vector<double, 3>, 3> Matrix2)
{
...
c_vector<double, 3> MembraneForcesBasic::MatrixMultiplication(c_vector<c_vector<double, 3>, 3> Matrix, c_vector<double, 3> Vector)
{
...
c_vector<c_vector<double, 3>, 3> MembraneForcesBasic::MatrixTranspose(c_vector<c_vector<double, 3>, 3> Matrix)
{
    c_vector<c_vector<double, 3>, 3> MatrixTranspose;
    for (int i = 0; i < 3; i++)
...
c_vector<c_vector<double, 3>, 3> MembraneForcesBasic::Inverse(c_vector<c_vector<double, 3>, 3> Matrix)
{
...
c_vector<c_vector<double, 3>, 3> MembraneForcesBasic::Inverse(c_vector<c_vector<double, 3>, 3> Matrix, double elem)
{
...
c_vector<c_vector<double, 3>, 3> MembraneForcesBasic::RowReduction(c_vector<c_vector<double, 3>, 3> Matrix)
{
...
c_vector<c_vector<double, 3>, 3> MembraneForcesBasic::MappingMatrix(MeshBasedCellPopulation<2, 3>* p_cell_population, typename AbstractTetrahedralMesh<2, 3>::ElementIterator elem_iter, double a, double b, double theta)
{
...
double MembraneForcesBasic::det(c_vector<c_vector<double, 2>, 2> Matrix)
{
...
double MembraneForcesBasic::tr(c_vector<c_vector<double, 2>, 2> Matrix)
{
...
void MembraneForcesBasic::OutputForceParameters(out_stream& rParamsFile)
{
