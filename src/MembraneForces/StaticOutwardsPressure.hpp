...
#ifndef StaticOutwardsPressure_HPP_
#define StaticOutwardsPressure_HPP_
 ...
 */
class StaticOutwardsPressure : public AbstractForce<2, 3>
...
public:
    ...
    double mStrength;
    std::map<double, c_vector<long double, 3> > mInitialNormals;

    void SetUpNormals(AbstractCellPopulation<2, 3>& rCellPopulation);
    
    /**
     * Constructor.
     */
    StaticOutwardsPressure();
...
#endif  /*StaticOutwardsPressure_HPP_*/
