...
template <unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void MembranePropertiesModifier<ELEMENT_DIM, SPACE_DIM>::SetMembranePropeties(std::map<double, c_vector<long double, 4> > GrowthMaps, double Strength, bool Hetrogeneous, double StepSize, double SetupSolve)
{
...
template <unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void MembranePropertiesModifier<ELEMENT_DIM, SPACE_DIM>::Boundaries(c_vector<double, 3> UpperPlaneNormal, c_vector<double, 3> UpperPlanePoint, c_vector<double, 3> LowerPlaneNormal, c_vector<double, 3> LowerPlanePoint)
{
...
template <unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void MembranePropertiesModifier<ELEMENT_DIM, SPACE_DIM>::SetBendingForce(AbstractCellPopulation<ELEMENT_DIM, SPACE_DIM>& rCellPopulation, double BendingConstant)
{
...
template <unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void MembranePropertiesModifier<ELEMENT_DIM, SPACE_DIM>::StepChange(AbstractCellPopulation<ELEMENT_DIM, SPACE_DIM>& rCellPopulation)
{
