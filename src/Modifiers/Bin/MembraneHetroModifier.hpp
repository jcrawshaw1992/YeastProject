...
#ifndef MembraneHetroModifier_HPP_
#define MembraneHetroModifier_HPP_
...
class MembraneHetroModifier : public AbstractCellBasedSimulationModifier<ELEMENT_DIM,SPACE_DIM>
{
private:
...
public:
	 ...
	 * Default constructor.
	 */
    MembraneHetroModifier();

    /**
     * Destructor.
     */
    virtual ~MembraneHetroModifier();
...
#endif /*MembraneHetroModifier_HPP_*/
