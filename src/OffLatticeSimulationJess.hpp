...
#ifndef OffLatticeSimulationJess_HPP_
#define OffLatticeSimulationJess_HPP_
 ...
 *
 * The OffLatticeSimulationJess is constructed with a CellPopulation, which
 ...
 * to the OffLatticeSimulationJess object, to define the mechanical properties
 * of the CellPopulation. Similarly, one or more CellKillers may be passed
 * to the OffLatticeSimulationJess object to specify conditions in which Cells
...
class OffLatticeSimulationJess : public AbstractCellBasedSimulation<ELEMENT_DIM,SPACE_DIM>
{
private:

    /** Needed for serialization. */
    friend class boost::serialization::access;
    friend class TestOffLatticeSimulationJess;
    friend class TestOffLatticeSimulationJessWithNodeBasedCellPopulation;
...
public:
     ...
     *     from an archive)
     */
    OffLatticeSimulationJess(AbstractCellPopulation<ELEMENT_DIM,SPACE_DIM>& rCellPopulation,
...
{
/**
 * Serialize information required to construct an OffLatticeSimulationJess.
 */
template<class Archive, unsigned ELEMENT_DIM, unsigned SPACE_DIM>
inline void save_construct_data(
    Archive & ar, const OffLatticeSimulationJess<ELEMENT_DIM,SPACE_DIM> * t, const unsigned int file_version)
{
...
/**
 * De-serialize constructor parameters and initialise an OffLatticeSimulationJess.
 */
template<class Archive, unsigned ELEMENT_DIM, unsigned SPACE_DIM>
inline void load_construct_data(
    Archive & ar, OffLatticeSimulationJess<ELEMENT_DIM,SPACE_DIM> * t, const unsigned int file_version)
{
    ...
    ::new(t)OffLatticeSimulationJess<ELEMENT_DIM,SPACE_DIM>(*p_cell_population, true, false);
}
}
} // namespace

#endif /*OffLatticeSimulationJess_HPP_*/
