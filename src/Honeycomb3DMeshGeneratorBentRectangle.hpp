#ifndef Honeycomb3DMeshGeneratorBentRectangle_HPP_
#define Honeycomb3DMeshGeneratorBentRectangle_HPP_
 ...
 */
class Honeycomb3DMeshGeneratorBentRectangle
{
protected:
...
public:
     ...
     */
    Honeycomb3DMeshGeneratorBentRectangle(unsigned numNodesAround, unsigned numNodesAlongLength, double radius, double length);

    /**
     * Null constructor for derived classes to call.
     */
    Honeycomb3DMeshGeneratorBentRectangle()
    {
    }
     ...
     */
    virtual ~Honeycomb3DMeshGeneratorBentRectangle();
...
#endif /*Honeycomb3DMeshGeneratorBentRectangle_HPP_*/
