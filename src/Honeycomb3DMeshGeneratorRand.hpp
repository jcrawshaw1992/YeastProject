#ifndef Honeycomb3DMeshGeneratorRand_HPP_
#define Honeycomb3DMeshGeneratorRand_HPP_
 ...
 */
class Honeycomb3DMeshGeneratorRand
{
protected:
...
public:
     ...
     */
    Honeycomb3DMeshGeneratorRand(unsigned numNodesAround, unsigned numNodesAlongLength, double radius, double length);

    /**
     * Null constructor for derived classes to call.
     */
    Honeycomb3DMeshGeneratorRand()
    {
    }
     ...
     */
    virtual ~Honeycomb3DMeshGeneratorRand();
...
#endif /*Honeycomb3DMeshGeneratorRand_HPP_*/
