...
ArbitraryVolumeConstraintPottsUpdateRule<DIM>::ArbitraryVolumeConstraintPottsUpdateRule()
...
template<unsigned DIM>
double ArbitraryVolumeConstraintPottsUpdateRule<DIM>::EvaluateHamiltonianContribution(unsigned currentNodeIndex,
                                                                        ...
                                                                        PottsBasedCellPopulation<DIM>& rCellPopulation)
{
    ...
    if (current_node_contained) // current node is in an element or is in an element
    {
        ...
        double current_volume = p_static_cast_potts_mesh->GetVolumeOfElement(current_element); //getareaofelement -> basically the sum of all the enclosed lattice sites.
    ...
    if (target_node_contained) // target node is in an element
    {
        ...
        double target_volume =  p_static_cast_potts_mesh->GetVolumeOfElement(target_element);
...
template<unsigned DIM>
double ArbitraryVolumeConstraintPottsUpdateRule<DIM>::GetDeformationEnergyParameter()
{
...
template<unsigned DIM>
void ArbitraryVolumeConstraintPottsUpdateRule<DIM>::SetDeformationEnergyParameter(double deformationEnergyParameter)
{
...
template<unsigned DIM>
double ArbitraryVolumeConstraintPottsUpdateRule<DIM>::GetMatureCellTargetVolume() const
{
...
template<unsigned DIM>
void ArbitraryVolumeConstraintPottsUpdateRule<DIM>::SetMatureCellTargetVolume(double matureCellTargetVolume)
{
...
template<unsigned DIM>
void ArbitraryVolumeConstraintPottsUpdateRule<DIM>::OutputUpdateRuleParameters(out_stream& rParamsFile)
{
...
template class ArbitraryVolumeConstraintPottsUpdateRule<2>;
template class ArbitraryVolumeConstraintPottsUpdateRule<3>;

// Serialization for Boost >= 1.36
#include "SerializationExportWrapperForCpp.hpp"
//EXPORT_TEMPLATE_CLASS_SAME_DIMS(ArbitraryVolumeConstraintPottsUpdateRule)
EXPORT_TEMPLATE_CLASS1(ArbitraryVolumeConstraintPottsUpdateRule, 2)
EXPORT_TEMPLATE_CLASS1(ArbitraryVolumeConstraintPottsUpdateRule, 3)



// template <unsigned DIM>
// void ArbitraryVolumeConstraintPottsUpdateRule<DIM>::CalculateLatticeVolumes(MutableMesh<2, DIM>& rMesh)
// {
