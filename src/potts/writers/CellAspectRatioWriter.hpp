#ifndef CellAspectRatioWriter_HPP_
#define CellAspectRatioWriter_HPP_
...
class CellAspectRatioWriter : public AbstractCellWriter<ELEMENT_DIM, SPACE_DIM>
{
private:
