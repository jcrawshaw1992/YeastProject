#ifndef CellSecAspectRatioWriter_HPP_
#define CellSecAspectRatioWriter_HPP_
...
class CellSecAspectRatioWriter : public AbstractCellWriter<ELEMENT_DIM, SPACE_DIM>
{
private:
