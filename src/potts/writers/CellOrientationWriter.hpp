#ifndef CellOrientationWriter_HPP_
#define CellOrientationWriter_HPP_
...
class CellOrientationWriter : public AbstractCellWriter<ELEMENT_DIM, SPACE_DIM>
{
private:
