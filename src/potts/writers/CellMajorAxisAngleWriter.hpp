#ifndef CellMajorAxisAngleWriter_HPP_
#define CellMajorAxisAngleWriter_HPP_
...
class CellMajorAxisAngleWriter : public AbstractCellWriter<ELEMENT_DIM, SPACE_DIM>
{
private:
