...
void PottsCellPropertiesModifier<DIM>::UpdateCellData(AbstractCellPopulation<DIM,DIM>& rCellPopulation)
{
	...
	/* Need to save certain properties of the cell 
	Step 1 -  Cast the rCellPopulation to the Potts Model I have 
	Step 2 - Iterate over the Cell population 
	Step 3 - Save the axis ratio for each cell in cell data 
	*/ 
	assert(DIM==3);
