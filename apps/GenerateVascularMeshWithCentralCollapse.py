...
if __name__=="__main__":
    ...
    Directory = "/home/vascrem/MeshCollection/IdealisedNetwork/CollapseBetween5And6/"
    ...
    Collapse = [0.6,0.61,0.62,0.63,0.64,0.65]
    for i in Collapse:
        ...
        print str(i)
        command = CPP_Centerlines_vtp_writer + ' -ofile ' + CenterLines_filename + ' -CenterlinePoints ' +Directory+ 'CenterlinePoints.txt -CenterlineEdges ' + Directory +'CenterlineEdges.txt -Radius 0.2 -LeftBound '+str(Boundaries[0])+' -RightBound '+str(Boundaries[1])+' -Collapse ' + str(i)
