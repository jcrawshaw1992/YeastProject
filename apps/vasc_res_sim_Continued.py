...
def WriteReadme(ElasticShearModulus, AreaDilationModulus, membrane_constant, Area_constant , Time_step, Sampling, duration ):
    print "**************   WriteReadme  **************   "
...
if __name__=="__main__":
    working_directory = '/Users/jcrawshaw/Documents/ChasteWorkingDirectory/IncreasedFluidPressure2/' 
...
# **** Set up what you need for the collected chaste mesh folder
    newpath = working_directory +'ChasteMeshes3rd/' 
    ...
    Hemepath = working_directory +'HemeLBFluid3rd/' 
    ...
    SamplingTimestepMultiple = 1 # changed from 10
    ...
    for iter in range(args.num_iterations):
        ...
        if FluidSimulation ==1:
            ...
            update_xml_file(iter+40, args.num_iterations)
