...
if __name__=="__main__":
    ...
    Collapse = ['20','18','19','17','16','15','14','13','12','11']
    ...
    for i in Collapse:
        ...
        #     dX = 0.2/15
        dX = 0.1/15
        write_pr2(mHemeLBDirectory, 20001, dX)
        run_hemelb_setup(mHemeLBDirectory )

        # Update the xml file
        update_xml_file(int(20001*0.8), mHemeLBDirectory)

        # # Run HemeLB
        RunHemeLB = 'mpirun -np 15 hemelb -in ' + mHemeLBDirectory+ 'config.xml -out '+mHemeLBDirectory +'Results3/'
