...
if __name__=="__main__":
    ...
    for Level in Scalling:
        ...
        for i in Collapse:
            ...
            if Level =='1':
                write_pr21(mHemeLBDirectory, 5001, dX, Seed, Boundaries)
            elif Level =='2':
                write_pr22(mHemeLBDirectory, 5001, dX, Seed, Boundaries)
            elif Level =='3':
                write_pr23(mHemeLBDirectory, 5001, dX, Seed, Boundaries)
            elif Level =='4':
                write_pr24(mHemeLBDirectory, 5001, dX, Seed, Boundaries)


            run_hemelb_setup(mHemeLBDirectory)

            # Update the xml file
            update_xml_file(int(5001*0.9), mHemeLBDirectory)
