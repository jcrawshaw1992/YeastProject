...
if __name__=="__main__":
    ...
    for j in BifucationAngles:
        AngleNewPath = HeadNewPath+j+"/"
        if path.isdir(AngleNewPath)==0:
            os.mkdir(AngleNewPath)
        
        for k in Length:
            NewPath = AngleNewPath+"HorizontalLength_"+k+"/"
            ...
            for i in Collapse:
                counter = counter+1
                print counter
                CurrentPath = TerminalOutputFolder+j+'/HorizontalLength_'+k+'/'+i  
                print CurrentPath
