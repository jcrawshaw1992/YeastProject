...
Directory = '/Volumes/Hardrive/Projects/FSI/VaryingEdgeLength/FlowFiles/'
# load state
LoadState('/Volumes/Hardrive/Projects/FSI/VaryingEdgeLength/LowerState.pvsm', DataDirectory=Directory,
    wholegeometryvelocity_0vtuFileName=[Directory +'/wholegeometry-velocity_0.vtu'])
...
for S in  Scalling:
    ...
    Y1 = -5.932599883238269e-5
    Y2 = 7.4595443653008e-5


    # All numbers in X Need to be Scalled by 0.0002
    MidPoint = MidPoint*0.0002
    FrontPoint = FrontPoint *0.0002
    X = X *0.0002
    ...
    # Properties modified on clip1.ClipType
    clip1.ClipType.Position = [X, Y1,0]
    ...
    slice1.SliceType.Origin = [X, Y1,0]
    slice1.SliceType.Normal = [0.7, 0.7, 0.0]
    ...
    # Properties modified on clip1.ClipType
    clip1.ClipType.Position = [X, Y2,0]
    ...
    # Properties modified on slice1.SliceType
    slice1.SliceType.Origin = [X, Y2,0]
