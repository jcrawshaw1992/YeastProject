...
if __name__=="__main__":
    ...
    # Collapse = ['0.417','0.5124', '0.6119', '0.708', '0.8059', '0.9032' , '0.1227', '0.2248'  , '1.0' ]
    # Collapse = ['0.417' ]
    ...
    # BifucationAngles = ['PI_5/','PI_2.2/','PI_3/','PI_6/'] 
    BifucationAngles = ['PI_5/','PI_2.2/','PI_3/','PI_6/'] 
    BifucationAngles = ['PI_2.2/'] 

    Collapse = [ '1.0' , '0.5124']#,  '0','0.1227','0.2248', '0.3178', '0.417', '0.5124', '0.708', '0.8059', '0.9032', ]
    ...
    #             write_pr2(mHemeLBDirectory, 10000, dX, Seed, Boundaries)
