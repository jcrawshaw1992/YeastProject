...
def CheckToReplaceResultsFolder(mHemeLBDirectory):
...
if __name__=="__main__":
    ...
    Collapse = ['0.5124', '0.6119', '0.708', '0.8059']  
    ...
    for Angle in BifucationAngles:
        ...
        for length in Lengths:
            ...
            for i in Collapse:
                ...
                # Generate waitFile
                WaitFileGeneration = TerminalOutputFolder+'WaitFileVar1'+str(Core)+'.txt'
                ...
                while len(AvaliablePaths) ==0:
                    ...
                    for P in range(Parallel):
                        OutputFile = TerminalOutputFolder+'WaitFileVar1'+str(P)+'.txt'
