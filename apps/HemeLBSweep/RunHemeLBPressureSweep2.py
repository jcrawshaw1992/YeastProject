...
def EditRunTime(working_directory):
    ...
    pattern = '<steps units="lattice" value="20000" />'
    subst = '<steps units="lattice" value="5000" />'
...
if __name__=="__main__":
    ...
    #         print mHemeLBDirectory
    #         subprocess.Popen(['./RunHemeLBSweepBash', " ", " ", GmyUnstructuredGridReader, GenerateFlowVtus, " " ])
