...
if __name__=="__main__":
    ...
    GenerateRunner =1
    if GenerateRunner ==1:
        command = "cd ~/Chaste && scons b=GccOpt projects/VascularRemodelling/test/ParameterSweep/TestBendingForceOnCylinder.hpp"
        subprocess.call(command, shell=True)
    Server = 1
    if Server ==1:
        chaste_run_exe = '/home/vascrem/Chaste/projects/VascularRemodelling/build/optimised/ParameterSweep/TestBendingForceOnCylinderRunner '
        TerminalOutputFolder = "/data/vascrem/testoutput/SweepOnCylinder/SweepTerminalOutputs/"
        mesh_file = "/home/vascrem/MeshCollection/Blobby.vtu"

        if path.isdir("/data/vascrem/testoutput/SweepOnCylinder/")==0:
            os.mkdir("/data/vascrem/testoutput/SweepOnCylinder/")
    else:
        chaste_run_exe =  '/Users/jcrawshaw/Chaste/projects/VascularRemodelling/build/optimised/ParameterSweep/TestBendingForceOnCylinderRunner '
        TerminalOutputFolder = "/Users/jcrawshaw/Documents/testoutput/SweepOnCylinder/SweepTerminalOutputs/"
    ...
    CollectResults =0
    if CollectResults ==1:
        NewFolder = "/data/vascrem/testoutput/SweepOnCylinder/CollectedResults2/"
        OldFolder = "/data/vascrem/testoutput/SweepOnCylinder/"
