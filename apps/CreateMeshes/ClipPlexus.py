...
if __name__=="__main__":
    print "B"
    file_basename = '/Users/jcrawshaw/Downloads/PlexusExampleSmall/results_from_time_0/Plexus.vtk'
    Save_name ='/Users/jcrawshaw/Downloads/PlexusExampleSmall/results_from_time_0/PlexusClipped.vtk'

    Origin = (0.04445307579525465, 0.05162259742566157, -0.001990588305433403)
    Normal = (-0.8105631234548122,-0.5853191641674113,0.019720521127546863)


    Origin2nd = (0.05,  0.04, -0.0006)
    ...
    # # clip_surface_with_plane(file_basename, (0.045098203892165734,0.05064189958380424,0.0011589943289266515), (0.8081276713886205,-0.5856195847394546,-0.06308223763940606), Save_name)
    # clip_surface_with_plane(vtkFile, plane_origin, plane_normal, save_name):
