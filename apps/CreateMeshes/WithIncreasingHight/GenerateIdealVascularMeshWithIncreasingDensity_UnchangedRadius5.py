...
if __name__=="__main__":
    ...
    Directory = "/data/vascrem/MeshCollection/IdealisedNetwork/IncreasingDensityScallingRadius/"
    ...
    for j in Levels:
        ...
        # Collapse = [ 0.4170, 0.5124, 0.6119, 0.7080, 0.8059, 0.9032, 1.0000]
        Collapse = [ 0.1227, 0.2248, 0.3178, 0.4170, 0.5124, 0.6119, 0.7080, 0.8059, 0.9032, 1.0000]
        ...
        for i in Collapse:
            ...
            command = 'vmtk vmtkcenterlinemodeller -ifile ' + CenterLines_filename +' -radiusarray Radius -dimensions 180 180 180 --pipe vmtkmarchingcubes -ofile '+ VTK_Mesh
            subprocess.call(command, shell=True)
