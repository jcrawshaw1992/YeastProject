...
if __name__=="__main__":
    ...
    Clipped_Mesh = Directory+"MeshClipped2.vtk"
    ...
    # command = 'vmtk vmtkcenterlinemodeller -ifile ' + CenterLines_filename +' -radiusarray Radius -dimensions 260 260 260 --pipe vmtkmarchingcubes -ofile '+ VTK_Mesh
    # subprocess.call(command, shell=True)
    
    # VTK_MeshRefined1 = Directory+"FirstRefined2.vtk"
    ...
    # The Mesh is currently dense and messy, remesh to get a nicer mesh, can control the target size of each element
    # command = 'vmtksurfaceremeshing -ifile '+VTK_MeshRefined1 +' -iterations 10 -edgelength 0.2 -elementsizemode "edgelength" -ofile ' + VTK_MeshRefined2
    # subprocess.call(command, shell=True)
    

    VTK_MeshRefined3 = Directory+"ThirdRefined.vtk"
    # # The Mesh is currently dense and messy, remesh to get a nicer mesh, can control the target size of each element
    command = 'vmtksurfaceremeshing -ifile '+VTK_MeshRefined2 +' -iterations 10 -edgelength 0.5 -elementsizemode "edgelength" -ofile ' + VTK_MeshRefined3
    subprocess.call(command, shell=True)

    
   
    Clipped_Mesh = Directory+"Clipped.vtk"
    clip.clip_surface_with_plane(VTK_MeshRefined3,(11,0,0), (1,0,0), Clipped_Mesh)
    clip.clip_surface_with_plane(Clipped_Mesh,(150,0,0), (-1,0,0), Clipped_Mesh)
