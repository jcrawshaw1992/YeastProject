...
def run_hemelb_setup():
   ...
   # TODO: It seems that when you use the --stl option below, the voxel size specified in .pr2 is ignored and the setup tool guesses one for you
    ...
    voxel_size =  0.666 #0.017262106761336327 # 0.15e-3
...
def update_xml_file(iter_num, num_iters):
    ...
    surface = ElementTree.SubElement(extr, 'propertyoutput', {'period': str(1000), 'file': 'surface-traction.xtr'}) # ElementTree.SubElement(extr, 'propertyoutput', {'period': str(10000), 'file': 'surface-traction.xtr'})
    ElementTree.SubElement(surface, 'geometry', type='surface')
    ElementTree.SubElement(surface, 'field', type='traction')

    surface = ElementTree.SubElement(extr, 'propertyoutput', {'period': str(1000), 'file': 'surface-tractions.xtr'}) # surface = ElementTree.SubElement(extr, 'propertyoutput', {'period': str(10000), 'file': 'surface-tractions.xtr'})
    ElementTree.SubElement(surface, 'geometry', type='surface')
    ElementTree.SubElement(surface, 'field', type='traction')
    ElementTree.SubElement(surface, 'field', type='tangentialprojectiontraction')    

    surface = ElementTree.SubElement(extr, 'propertyoutput', {'period': str(1000), 'file': 'surface-pressure.xtr'}) # surface = ElementTree.SubElement(extr, 'propertyoutput', {'period': str(10000), 'file': 'surface-pressure.xtr'})
    ElementTree.SubElement(surface, 'geometry', type='surface')
    ElementTree.SubElement(surface, 'field', type='pressure')

    wholegeometry = ElementTree.SubElement(extr, 'propertyoutput', {'period': str(1000), 'file': 'wholegeometry-velocity.xtr'}) #wholegeometry = ElementTree.SubElement(extr, 'propertyoutput', {'period': str(10000), 'file': 'wholegeometry-velocity.xtr'})
...
if __name__=="__main__":
    working_directory = '/Users/jcrawshaw/Documents/ChasteWorkingDirectory/Bifucation_Hetrogeneous/' 
...
# **** Set up what you need for the collected chaste mesh folder
    ...
    duration =  0.1# changed from 0.001
