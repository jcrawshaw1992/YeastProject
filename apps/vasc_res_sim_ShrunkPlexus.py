...
chaste_setup_exe = '/Users/jcrawshaw/Documents/Chaste/projects/VascularRemodelling/build/optimised/HemeLBChasteTests/TestSetupFlowInShrunkPlexusRunner'
...
if __name__=="__main__":
    working_directory = '/Users/jcrawshaw/Documents/ChasteWorkingDirectory/ShrunkPlexus/' 
...
# **** Set up what you need for the collected chaste mesh folder
    ...
    chaste_setup_call = chaste_setup_exe +' -mesh ' + mesh_filename + ' -xml ' + xml_filename + ' -div_threshold ' +  str(args.div_threshold) + ' -mesh_scale ' +  str(args.mesh_scale) + ' -wss_threshold ' + str(0.025)  + Time_step  +Sampling +ScallingFactor
